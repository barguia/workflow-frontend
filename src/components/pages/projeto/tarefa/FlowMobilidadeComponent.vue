...
// direção em que ele aparece na cadeia. `caminho_critico` é uma flag por
// mobilidade (pivot), não um tipo de relacionamento (só existem Avanço e
// Devolução — CtrlMobilidadeTipoEnum), então não entra no diagrama como edge
// própria nem como filtro no painel — só marca visualmente as tarefas.
