  ...
  >
    <div>
      ...
      <ButtonComponent
        class="mt-6"
        color="primary"
        data-testid="ficha-tecnica-btn-voltar-404"
        @click="router.back()"
      >
        <IconComponent start>
          mdi-arrow-left
  ...
  >
    ...
    <div class="d-flex align-center gap-3 mb-4">
      <ButtonComponent
        ...
        variant="text"
        size="small"
        data-testid="ficha-tecnica-btn-voltar"
        @click="router.back()"
      />
      <div class="flex-1-1">
          ...
          <CardTextComponent class="pa-5">
            ...
            <RowComponent density="compact">
              ...
              >
                ...
                <div class="field-value">
                  {{ projeto.workflow?.ctrl_workflow?.workflow ?? '—' }}
                </div>
              </ColComponent>
              <ColComponent
                cols="12"
              ...
              >
                ...
                <div class="field-value">
                  {{ formatarDataHora(projeto.workflow?.created_at) }}
                </div>
              </ColComponent>
              <ColComponent
                cols="12"
              ...
              >
                ...
                <div class="field-value">
                  {{ projeto.workflow?.finalized_at ? formatarDataHora(projeto.workflow.finalized_at) : '—' }}
                </div>
              </ColComponent>
            </RowComponent>
          </CardTextComponent>
      ...
      <div class="d-flex align-center gap-3 mb-3 flex-wrap">
        ...
        >
          <ButtonComponent
            ...
            data-testid="ficha-tecnica-btn-tarefas-pendentes"
          >
            Pendentes
          </ButtonComponent>
          <ButtonComponent
            ...
            data-testid="ficha-tecnica-btn-tarefas-finalizadas"
          >
            Finalizadas
          </ButtonComponent>
        </v-btn-toggle>
        <ButtonComponent
          ...
          data-testid="ficha-tecnica-btn-atualizar"
          @click="buscarTarefas"
        >
          <IconComponent start>
            mdi-refresh
