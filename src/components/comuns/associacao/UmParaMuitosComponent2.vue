        ...
        <FormComponent v-model="form">
          <RowComponent>
            ...
            >
              ...
              <div class="text-h6 mb-2">{{ grupo.grupo }}</div>
              ...
              >
                <template #label>
                  <v-chip
                      :color="form.selecionados.includes(opcao.value) ? 'primary' : 'grey-lighten-2'"
                      size="small"
...
const props = defineProps({
  ...
  campoAgrupamento: { type: String, default: 'grupo' },
  selecionados: {type: Object},
...
const itensSelecionados = props.selecionados
const todosItens = ref([])
const itensAgrupados = props.todosItens
